...
pub enum Error {
    ...
    Indexer(#[from] crate::indexer::Error),

    /// Provider error
    #[error("provider error: {0}")]
    Provider(#[from] crate::providers::Error),
...
mod tests {
    ...
    fn test_error_indexer_display() {
        let indexer_err = crate::indexer::Error::IndexNotFound("test-index".to_string());
    ...
    fn test_error_provider_display() {
        let provider_err = crate::providers::Error::NotFound("bad url".to_string());
