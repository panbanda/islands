...
//!
//! ```rust,no_run
//! use islands_providers::{GitHubProvider, GitProvider};
//!
//! #[tokio::main]
//! async fn main() -> islands_providers::Result<()> {
...
//!
//! ```rust,no_run
//! use islands_providers::{ProviderFactory, create_provider};
//!
//! # fn main() -> islands_providers::Result<()> {
//! // Using the factory
...
pub mod prelude {
    pub use crate::BitbucketProvider;
    pub use crate::GitHubProvider;
    pub use crate::GitLabProvider;
    pub use crate::GiteaProvider;
    pub use crate::base::{AuthType, GitProvider, ProviderAuth, ProviderConfig, Repository};
    pub use crate::error::{ProviderError, Result};
    pub use crate::factory::{ProviderFactory, ProviderType, create_provider};
}
