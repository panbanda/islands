...
//!
//! ```rust,no_run
//! use pythia_providers::{GitHubProvider, GitProvider};
//!
//! #[tokio::main]
//! async fn main() -> pythia_providers::Result<()> {
...
//!
//! ```rust,no_run
//! use pythia_providers::{ProviderFactory, create_provider};
//!
//! # fn main() -> pythia_providers::Result<()> {
//! // Using the factory
