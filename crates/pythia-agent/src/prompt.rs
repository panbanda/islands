//! System prompts for the Pythia agent

/// Default system prompt for the Pythia codebase assistant
pub const DEFAULT_SYSTEM_PROMPT: &str = r#"You are Pythia, an intelligent codebase assistant. You help developers understand and navigate codebases by answering questions about code structure, implementation details, and best practices.
...
mod tests {
    ...
    fn test_default_system_prompt_exists() {
        ...
        assert!(DEFAULT_SYSTEM_PROMPT.contains("Pythia"));
    }
    ...
    fn test_build_messages_full_flow() {
        ...
        assert!(messages[0].content.contains("Pythia"));
